...
authors:
  - name: Yaping Li
    url: 
    institution: Shanghai AI Laboratory, The Chinese University of Hong Kong
    notes: ["*"]
  - name: Yang Tian
    url: 
    institution: Shanghai AI Laboratory, Peking University
    notes: ["*"]
  - name: Liang Pan
    url: 
    institution: Shanghai AI Laboratory, The University of Hong Kong
  - name: Yuxi Wei
    url: 
    institution: Shanghai AI Laboratory, Shanghai Jiao Tong University
  - name: Runyi Yu
    url: 
    institution: Shanghai AI Laboratory, The Hong Kong University of Science and Technology
  - name: Qifeng Chen
    url: 
